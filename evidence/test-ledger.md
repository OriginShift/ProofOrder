...
| --- | --- | --- | --- |
| T01 | Valid result | proof, balances, recovery and re-evaluation | [Local encrypted delivery, signed attestation, exact fixed-payee payout and independent offline recovery](runs/0014-verified-settlement.json) passed; ZK/fair exchange pending |
