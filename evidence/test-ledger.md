...
| --- | --- | --- | --- |
| T01 | Valid result | proof, balances, recovery and re-evaluation | settlement path passed; proof/recovery integration pending |
...
| T10 | Duplicate submit/settle | idempotent rejection | contract path passed |
| T12 | Provider abort | bounded exit/refund | timeout refund path passed; provider-specific abort pending |
